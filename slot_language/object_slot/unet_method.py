...
from unet_model import PosUNetSlotAttentionModel
...
class UNetSlotAttentionVideoLanguageMethod(ObjSlotAttentionVideoLanguageMethod
                                           ):
    ...
    def sample_images(self):
        ...
        if isinstance(self.model, PosUNetSlotAttentionModel):
            all_masks = slots
